...
def get_trips(year: int, data_dir_rel_path="../data/") -> pd.DataFrame:
    """
    ...
    __convert_trips_dtypes(trips, year)
...
def __convert_trips_dtypes(trips: pd.DataFrame, year: int) -> None:
